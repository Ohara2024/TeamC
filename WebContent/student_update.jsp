...
<body>
    ...
    <div class="content">
        ...
        <%
            // Define database connection variables at a higher scope
    ...
    <script>
        ...
        function updateFormGroupClasses() {
            let nameGroup = document.getElementById('name').parentElement.parentElement;
            nameGroup.classList.toggle('has-warning', document.getElementById('name_warning').style.display === 'block');

            let classNumGroup = document.getElementById('class_num').parentElement.parentElement;
